...
export default function ExportButton({ subject, muscleSet }) {
  ...
  async function doExport() {
    ...
    setStatus(null);
    try {
      const res = await api.postMuscle(subject, channels);
      setStatus({
        kind: 'ok',
  ...
  return (
    <div className="export-box">
      <button className="export-btn" disabled={!subject || busy} onClick={doExport}>
